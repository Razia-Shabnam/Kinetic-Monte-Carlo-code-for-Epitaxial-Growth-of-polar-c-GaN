//Subroutine for diffusion of N atom at  height multiple of 7, 15, 23.... Each N atom will have only two sites for rotation which depands on the position of Ga bond to which N atom is linked. This subroutine checks all the 18 diffuison sites. If no site found diffusion fails.
