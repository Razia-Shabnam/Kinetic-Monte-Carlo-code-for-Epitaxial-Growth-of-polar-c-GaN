//Subrountine for diffusion of AdGa atom at  height multiple of 7, 15, 23,.....This subroutine checks all the 18 diffuison sites. If no site found diffusion fails.
